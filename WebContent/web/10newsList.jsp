	...
	<div style="height: 20px;"></div>
		...
		<div style="padding-bottom: 80px;">
			<div class="container-fluid" style="margin-top: 80px;">
				...
				<p class="f1">
					新闻动态<span class="f3"> Company News</span>
				</p>
			</div>
			<div class="container-fluid" style="margin-top: 80px;">
					...
					<c:forEach items="${page.beanList }" var="news">
						<div>
							<ul style="list-style-image: url(${ pageContext.request.contextPath }/img/ico_2.gif);border-bottom:dashed 2px #C0C5D5;">
								<li style="padding: 10px 0;"><span><a href="${pageContext.request.contextPath}/new_findById.action?nt_id=${news.nt_id}">${news.nt_top } </a></span><span style="float: right;">[${news.nt_time }]</span></li>
							</ul>
						</div>
					</c:forEach>
					<form action="${pageContext.request.contextPath }/new_findByPage3.action" name="Form" method="post">
