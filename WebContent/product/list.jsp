...
<BODY>
	<FORM id="productForm" name="productForm" action="${pageContext.request.contextPath }/product_findByPage1.action" method=post>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<c:forEach items="${page.beanList}" var="product">
													<TR
														...
														<TD>
														<a href="${pageContext.request.contextPath }/product_initUpdate.action?pro_id=${product.pro_id}">修改</a>
														&nbsp;&nbsp;
														<a href="${pageContext.request.contextPath }/product_delete.action?pro_id=${product.pro_id}" onclick="return window.confirm('确定删除吗？')">删除</a>
														</TD>
													</TR>
												</c:forEach>
