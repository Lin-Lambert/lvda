...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/notice_save.action"
						...
						<TBODY>
							<TR>
								<TD vAlign=top width="100%" bgColor=#ffffff>
									<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
										<TR>
											<TD class=manageHead>当前位置：公告栏管理 &gt; 添加公告</TD>
										</TR>
										<TR>
											<TD height=2></TD>
										</TR>
													...
													<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
														<tr>
															...
															<td><INPUT class="textbox" id=check1
																style="WIDTH: 180px" maxLength=50 name="notice_title"></td>
															<td>时间：</td>
							...
							<TR>
								<TD colspan="5">
									...
									<input type="hidden" id="detail" value="" name="notice_detail">
