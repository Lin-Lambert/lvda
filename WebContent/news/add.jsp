...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/new_save.action"
									...
									<TABLE cellSpacing=0 cellPadding=5 border=0>
										...
										<TR>
											...
											<td><INPUT class="textbox" id=check1
												style="WIDTH: 180px" maxLength=50 name="nt_headline1">
											</td>
											<td>标题1（英语） ：</td>
											<td><INPUT class="textbox" id=check2
												style="WIDTH: 180px" maxLength=50 name="nt_smallheadline1">
											</td>
										</TR>
										<TR>
											<td>标题2：</td>
											<td><INPUT class="textbox" id=check3
												style="WIDTH: 180px" maxLength=50 name="nt_headline2">
											</td>
											<td>标题2（英语） ：</td>
											<td><INPUT class="textbox" id=check4
												style="WIDTH: 180px" maxLength=50 name="nt_smallheadline2">
											</td>
										</TR>
										<TR>
											<td colspan="4">
													...
													<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
														<tr>
															...
															<td><INPUT class="textbox" id=check5
																style="WIDTH: 180px" maxLength=50 name="nt_top">
															</td>
															<td>脚标题：</td>
															<td><INPUT class="textbox" id=check6
																style="WIDTH: 180px" maxLength=50 name="nt_footer">
															</td>
														</tr>
														<tr>
															<td>时间：</td>
															<td><INPUT class="textbox check7" id=timeId
																style="WIDTH: 180px" maxLength=50 name="nt_time"
																readonly="readonly"></td>
															<td>图片：</td>
															<td><INPUT class="textbox" id=check8 type="file"
														...
														<tr>
															...
															<td colspan="3"><textarea id=check9 rows="5"
																	cols="50" name="nt_content"></textarea></td>
														</tr>
													</TABLE>
												</fieldset>
											</td>
										...
										<TR>
											<td colspan="4">
												<fieldset>
													...
													图片：<INPUT class="textbox" id=check10 type="file"
							...
							<TR>
								<TD colspan="5">
									<table id="menu" style="width:100%" cellSpacing=0 cellPadding=0 width="98%" border=0>
										<tr>
											<td align="center">
												<textarea name="content1" cols="100" rows="20" style="width: 100%; height: 200px;"></textarea> 
												<br />
											</td>
										</tr>
									</table>
