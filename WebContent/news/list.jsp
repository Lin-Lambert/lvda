...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/new_findByPage1.action" method=post>
											...
											<TBODY>
												...
												<c:forEach items="${page.beanList}" var="news">
													<TR
														...
														<TD>${news.nt_headline1 }</TD>
														<TD>${news.nt_headline2 }</TD>
														
														<TD>${news.nt_time }</TD>
														
														<TD>
														<a href="${pageContext.request.contextPath }/new_initUpdate.action?nt_id=${news.nt_id}">修改</a>
														&nbsp;&nbsp;
														<a href="${pageContext.request.contextPath }/new_delete.action?nt_id=${news.nt_id}" onclick="return window.confirm('确定删除吗？')">删除</a>
														</TD>
													</TR>
												</c:forEach>
