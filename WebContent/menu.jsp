...
<SCRIPT language=javascript>
	function MenuDisplay(obj_id) {
		...
		if (obj) {
			if (obj.style.display == 'none' && document.getElementById(obj_id + 'Span').innerText == '＋') {
		...
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					...
					<TD style="vertical-align: middle;" width=180 background=${pageContext.request.contextPath }/img/new_006.jpg height=35><B>管理
							－信息</B></TD>
							...
							<TBODY>
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
										class=span id=table_1Span>＋</SPAN> 新闻管理</TD>
								</TR>
								<TR>
									<TD>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${ pageContext.request.contextPath }/news/add.jsp"
														target=main>－ 新增新闻</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${ pageContext.request.contextPath }/new_findByPage1.action"
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 公告栏管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${ pageContext.request.contextPath }/notice/add.jsp"
														target=main>－ 新增公告</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${ pageContext.request.contextPath }/notice_findByPage1.action"
														target=main>－ 公告列表</A></TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_3');"><SPAN
										class=span id=table_3Span>＋</SPAN> 产品管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${ pageContext.request.contextPath }/product/add.jsp"
														target=main>－ 新增产品</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
														href="${ pageContext.request.contextPath }/product_findByPage1.action"
		...
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					...
					<TD style="vertical-align: middle;" width=180 background=${pageContext.request.contextPath }/img/new_011.jpg height=15></TD>
